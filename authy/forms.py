...
class SignupForm(forms.ModelForm):
	username = forms.CharField(widget=forms.TextInput(attrs={'class': 'input is-medium'}) , required=True,)
...
class EditProfileForm(forms.ModelForm):
	...
	radio_choice=[("private","private"),("public","public")]
	type_account = forms.ChoiceField(choices=radio_choice, widget=forms.RadioSelect )
	sms_choice=[("yes","yes"),("no","no")]
	send_mail=forms.ChoiceField(choices=sms_choice , widget=forms.RadioSelect )
	...
	class Meta:
		model = Profile
		fields = ('picture', 'first_name', 'last_name', 'location', 'url', 'profile_info','type_account','send_mail')